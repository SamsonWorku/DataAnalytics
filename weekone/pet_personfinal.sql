...
insert into pet values (10, 'fifi', 'dog', 4, 0);
insert into pet values (11, 'toto', 'dog', 8, 0);
insert into pet values (12, 'cat1', 'cat', 5, 0);
insert into pet values (13, 'cat2', 'cat', 5, 0);
insert into pet values (14, 'cat3', 'cat', 6, 0);
insert into pet values (15, 'cat4', 'cat', 8, 0);
insert into pet values (16, 'cat5', 'cat', 3, 0);
insert into pet (id, name, breed, age, dead)
	values (0, "Fluffy", "Unicorn", 1000, 1);
/*insert into pet values (0, 'Fluffy', 'Unicorn', 1000, 0);*/
insert into pet values (1, 'Gigantor', 'Robot',1,0);
insert into pet values (2, 'Reese', 'Ugly', 1, 0);
insert into pet values (5, 'Cup Cake', 'Mean', 2, 0);
insert into pet values (6, 'Sprout', 'Big', 10, 0);
...
insert into pet (id, name, breed, age, dead)
	values (3, "Fluffy", "dog", 8, 0);
insert into pet values (4,'Pinky','dog', 4, 0);
insert into pet values (21, 'Buffy', 'cat', 8, 0);
insert into pet values (7, 'Snowy', 'cat', 2, 0);
insert into pet values (8, 'Tinkerbell', 'cat', 17, 0);
insert into pet values (9, 'Sandy', 'parrot', 40, 0);
insert into pet values (17, 'Cutie', 'snake', 22, 0);
insert into pet values (18, 'Spot', 'dog', 6, 0);    
insert into pet values (19, 'Ginger', 'dog', 11, 0);
insert into pet values (20, 'Rover', 'cat', 18, 1);    
...
select * from pet;
insert into pet values (0, 'fluffy', 'unicorn', 0, 0);
insert into pet values (20, 'Rover', 'cat', 18,1);
